...
<body>
 ...
 %>
	...
	<main>
		...
		<div
			class="flex-md-equal p-3 p-md-5 m-md-3 text-center bg1">
			<div class="col-md-5 mx-auto my-3">
				<h1 class="display-3 fw-bold">GROMI</h1>
				<p class="lead fw-bold">알고싶은 식물을 검색하고</br> 원하는 식물에 대해 찾아보세요!</p>
				<a class="btn btn-outline-secondary" href="./gardenList.jsp">많은
					식물 알아보기</a>
			</div>
		...
		<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
			<div
				...
				<div class="my-3 py-3">
					...
					<a class="btn btn-outline-secondary" href="./gardenList.jsp">식물 추천 바로가기</a>
				</div>
			...
			<div
				...
				<div class="my-3 p-3">
					...
					<a class="btn btn-outline-secondary" href="./gardenList.jsp">커뮤니티 바로가기</a>
				</div>
