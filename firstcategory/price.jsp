    ...
    <div class="row">
        <div class="col-md-12 text-center mb-5">
            <h1 class="fw-bold" style="font-family: 'Arial Rounded MT Bold', sans-serif; font-size: 50px;">
                <span style="color: green; text-decoration: underline;">가격대</span>을 찾고 있나요?</h1>
        </div>
        <div class="col-md-12 d-flex justify-content-center">
            <div class="d-flex justify-content-center">
                ...
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">5천원 미만</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">5천원-1만원</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">1-3만원</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">3-5만원</button>
            </div>
        </div>
        <div class="col-md-12 d-flex justify-content-center mt-3">
            <div class="d-flex justify-content-center">
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">5-10만원</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">10만원 이상</button>
