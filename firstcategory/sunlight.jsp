    ...
    <div class="container-fluid d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="row">
            <div class="col-md-12 text-center mb-5">
                ...
                <span style="color: green; text-decoration: underline;">광도요구</span>를 찾고 있나요?</h1>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
                ...
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">낮은 광도</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">중간 광도</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 26px;">높은 광도</button>
