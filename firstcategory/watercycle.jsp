            ...
            <div class="row">
                <div class="col-md-12 text-center mb-5">
                    <h1 class="fw-bold" style="font-family: 'Arial Rounded MT Bold', sans-serif; font-size: 50px;">
                        <span style="color: green; text-decoration: underline;">물주기</span>를 찾고 있나요?
                    </h1>
                </div>
                <div class="col-md-12 d-flex justify-content-center">
                    ...
                    <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 22px;">항상 흙을 축축하게 유지(물에 잠김)</button>
                    <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 22px;">흙을 촉촉하게 유지(물에 잠기지 않도록 유지)</button>
                </div>
                <div class="col-md-12 d-flex justify-content-center mt-3">
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 22px;">토양 표면이 말랐을 때 충분히 관수</button>
                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1" onclick="toggleButton(this)" style="border-color: gray; color: gray; font-size: 22px;">화분 흙 대부분 말랐을 때 충분히 관수</button>
