        ...
        <body>
            <nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="main-navbar">
                <div class="container">
                    ...
                    <div class="box">
                        ...
                        <!-- <div class="role">
                            <div class="block"></div>
                            <p style="margin-top: 0px;margin-bottom: 0px">plant information</p>
                        </div> -->
                    </div>
                    </a>
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-center"
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center mb-5">
                                <h1 class="fw-bold"
                                    style="font-family: 'Arial Rounded MT Bold', sans-serif; font-size: 50px;">어떤 식물을
                                    추천해 드릴까요?</h1>
                            </div>
                            <div class="col-md-12 d-flex justify-content-center">
                                <div class="d-flex justify-content-center"></div>
                                <button class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
            ...
            <script>
                function toggleButton(button) {
                    ...
                    button.style.color = button.classList.contains('active') ? 'green' : 'gray';
                    if (button.classList.contains('active') && button.textContent.trim() === '광도요구') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '생육형태') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '잎색') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '잎무늬') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '열매색') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '꽃피는 계절') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '겨울 최저온도') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '가격대') {
                    ...
                    } else if (button.classList.contains('active') && button.textContent.trim() === '물주기') {
